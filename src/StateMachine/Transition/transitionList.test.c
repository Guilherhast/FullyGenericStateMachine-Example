...
START_TEST(test_TransitionNode_createFull) {
  TransitionNode *nd;
  Transition *trn;
  ...
  nd = TransitionNode_createFull(stt, stt->name, &trnFunc, data, nxt);
...
START_TEST(test_TransitionList_searchByName) {
  ...
  nd1 = TransitionNode_createFull(stt1, stt1->name, &trnFunc, NULL, NULL);
  nd2 = TransitionNode_createFull(stt2, stt2->name, &trnFunc, NULL, NULL);
  nd3 = TransitionNode_createFull(stt3, stt3->name, &trnFunc, NULL, NULL);
  nd4 = TransitionNode_createFull(stt4, stt4->name, &trnFunc, NULL, NULL);
  ...
  r1 = TransitionList_searchByName(list, n1);
  r2 = TransitionList_searchByName(list, n2);
  r3 = TransitionList_searchByName(list, n3);
  r4 = TransitionList_searchByName(list, n4);
...
Suite *smc_state_list_suite(void) {
  ...
  tcase_add_test(tc_sm, test_TransitionNode_createFull);
  tcase_add_test(tc_sm, test_TransitionList_searchByName);
  /*
