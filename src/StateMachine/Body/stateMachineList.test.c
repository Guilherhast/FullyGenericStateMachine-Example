...
START_TEST(test_StateMachineNode_createFull) {
  ...
  nd = StateMachineNode_createFull(1, stt, NULL, NULL, NULL, nxt);
...
START_TEST(test_StateMachine_idMatch) {
  ...
  StateMachine *smc = StateMachine_create(5, stt, NULL, NULL, NULL);
...
START_TEST(test_StateMachineList_searchById) {
  ...
  nd1 = StateMachineNode_createFull(1, stt, NULL, NULL , NULL, nxt);
  nd2 = StateMachineNode_createFull(2, stt, NULL, NULL , NULL, nxt);
  nd3 = StateMachineNode_createFull(3, stt, NULL, NULL , NULL, nxt);
  nd4 = StateMachineNode_createFull(4, stt, NULL, NULL , NULL, nxt);
