...
SUBMODOBJ_STATEMACHINE_TRANSITION=$(TARGET_DIR)/transition.o
...
### SubModule Condition
SUBMODOBJ_STATEMACHINE_CONDITION=$(TARGET_DIR)/stateCondition.o
...
### SubModule State
SUBMODOBJ_STATEMACHINE_STATE=$(TARGET_DIR)/state.o
...
### SubModule Body
SUBMODOBJ_STATEMACHINE_BODY=$(TARGET_DIR)/stateMachine.o
...
$(MODOBJ_STATEMACHINE): $(shell find $(MODULE_STATEMACHINE) $(FNDARGS))
	$(SAFE)  $(MKC) $(MODULE_STATEMACHINE) full_mod BUILD=$(BUILD)

## Adding to all modules
ALL_MODOBJS+=$(MODOBJ_STATEMACHINE)
